...
@Component({ selector: 'app-pricing', standalone: true, imports: [RouterLink], templateUrl: './pricing.html', styleUrl: './pricing.css' })
export class PricingComponent implements AfterViewInit {
  ...
  toggleFaq(i: number) { this.openFaq.update(v => v === i ? -1 : i); }
